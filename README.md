...
**推荐运行方式（以 Claude Code 为例）**：

```bash
# 克隆仓库
git clone https://github.com/ShiQing-Chen/god-skill.git
...
仓库地址：[https://github.com/ShiQing-Chen/god-skill](https://github.com/ShiQing-Chen/god-skill)
